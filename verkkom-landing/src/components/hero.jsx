import React, { useState } from 'react'; // Arreglado: Añadimos useState
import { Button } from '../ui/Button';
import { ShieldCheck, HardHat, CheckCircle } from 'lucide-react';
// Eliminamos Link y NavLink porque no se están usando aquí
...
export function Hero() {
  ...
  const openModal = () => {
    setIsModalOpen(true);
    // Borramos closeMenu() porque no existe en este componente y causaba error
  };
        ...
        <div className="vk-hero-container">
          <div className="vk-hero-content">
            ...
            <div className="vk-hero-btns">
              <Button variant="primary" className="btn-hero-main" onClick={openModal}>
                CONTRATAR AHORA
              </Button>
